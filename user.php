        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="box" data-aos="fade-up">
              <img src="assets/images/CheckStatus.jpg" style="max-height: 340px;" alt="">
              <div class="btn-wrap">
                <a href="checkStatus.php" class="btn-buy">Check Status</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box featured" data-aos="fade-up" data-aos-delay="100">
              <img src="assets/images/ApplyLoan.jpg" style="max-height: 340px;" alt="">
              <div class="btn-wrap">
                <a href="applyLoan.php" class="btn-buy">Apply for Loans</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="200">
              <img src="assets/images/SanctionedLoans.jpg" style="max-height: 350px;" alt="">
              <div class="btn-wrap">
                <a href="sanctionedLoans.php" class="btn-buy">Sanctioned Loans</a>
              </div>
            </div>
          </div>
