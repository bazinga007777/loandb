...
if (isset($_POST['upload'])) {
  ...
  if ($fileActualExt == 'pdf') {
    if ($fileSize < 10000000) {
      ...
      $dt = date('Y-m-d h:i:s');
      $sql = "INSERT INTO `loanforms`(`type`, `doc`, `username`, `city`, `branch`, `date`) VALUES ('Home', '$filenameNew', '$username', '$city', '$branch' ,'$dt')";
                  ...
                  <fieldset>
                    <div class="form-card" style="height: 200px;">
                      ...
                      <div class="container text-center mt-4">
                        <a href="download.php?file=home.pdf" class="btn btn-primary ml-auto" type="button">Download</a>
                      </div>
                    </div>
