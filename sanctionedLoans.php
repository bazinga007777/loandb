    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <?php
        ...
        if($num_rows==0){
          ...
          <div class='h1 text-center' style='padding-top: 250px'>You don't have any sanctioned loans right now!</div>
          </div>
          ";
        }
    else{
    echo '<div class="container my-4 p-3">
    <h2 class="text-center mb-3" style="color: #5995fd">Your Sanctioned Loans</h2>
